        ...
        <div class="col col-lg-6">
          ...
          <div class="card card-primary mt-3">
            ...
            <div class="card-body">
              ...
              <form method="post" id="add_create" name="add_create" action="<?= site_url('producto/modificarProducto') ?>">
                ...
                <textarea class="form-control" id="descripcion" type="text" value="<?php echo $row->descripcion; ?>" name="descripcion" rows="3"></textarea> 
                </div> -->
                  ...
                  <div class="row">
                    <div class="col-6">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" class="form-control" name="precio" value="<?php echo $row->precio; ?>" placeholder="Ingrese el precio por m³ del producto">
                    ...
                    <div class="col-6"> 
                      ...
                      <div class="input-group mb-3">
                        <input id="stock" type="text" class="form-control" name="stock" value="<?php echo $row->stock; ?>" placeholder="Ingrese el Stock inicial del producto" required>
                        <div class="input-group-append">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-primary" onclick="return confirm('Usted quiere actualizar los datos de producto?');">Guardar</button>
                </div>
              </form>
            </div>
          </div>
